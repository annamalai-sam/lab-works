...
insert into faq(question,mail,name) values("What is the course fee?","test1@abc.com","test1"),("What is the duration of the program?","test2@abc.com","test2"),("Can I reapply?","test3@abc.com","test3"),("What is expected of me during the FWSA programme?","test4@abc.com","test4");

insert into 
users
(role_id,first_name,last_name,email,contact_number,date_of_birth,Gender,parent_name,parent_contact_number,address) 
values
...
insert into admin_details(user_id,password) values("1","passw@01"),("2","passw@02");

insert into application_status(user_id,result) values
("3","pending"),
("4","selected"),
("5","pending"),
("6","selected"),
...
insert into application_result_checking_details (user_id) values (3),(4),(5);